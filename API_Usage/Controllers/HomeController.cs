    ...
    ****/
    ...
    public IActionResult SaveCharts(string symbol)
    {
        ...
        public IActionResult Refresh(string tableToDel)
        {
            ...
            tableCount.Add("TopGainers", dbContext.TopGainers.Count());
            tableCount.Add("TopLosers", dbContext.TopLosers.Count());
            tableCount.Add("MostActive", dbContext.MostActives.Count());
        ...
        public void ClearTables(string tableToDel)
        {
            if ("all".Equals(tableToDel))
            {
                ...
                dbContext.TopGainers.RemoveRange(dbContext.TopGainers);
                dbContext.TopLosers.RemoveRange(dbContext.TopLosers);
                dbContext.MostActives.RemoveRange(dbContext.MostActives);
            ...
            else if ("TopGainers".Equals(tableToDel))
            {
                dbContext.TopGainers.RemoveRange(dbContext.TopGainers);
            }
            else if ("TopLosers".Equals(tableToDel))
            {
                dbContext.TopLosers.RemoveRange(dbContext.TopLosers);
            }
            else if ("MostActives".Equals(tableToDel))
            {
                dbContext.MostActives.RemoveRange(dbContext.MostActives);
            }
